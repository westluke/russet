...
// Stop writing methods before you need them!
// You didn't need fbuflayer.write!
// impl From<Card> for FrameBufLayer {
//     fn from (c: Card) {
//         let fbuflayer = FrameBufLayer::new(
//     }
// }
